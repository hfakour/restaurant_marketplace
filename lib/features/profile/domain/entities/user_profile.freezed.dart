...
mixin _$UserProfile {
  ...
  List<PaymentMethodRef> get paymentMethodRefs =>
      throw _privateConstructorUsedError; // NEW: Orders the user has placed (lightweight snapshots)
  List<OrderRef> get orderRefs =>
      throw _privateConstructorUsedError; // NEW: Things the user has favorited
  List<FavoriteRef> get favoriteRefs =>
      throw _privateConstructorUsedError; // NEW: Discounts/coupons associated to or last applied by the user
  // (e.g., per-user codes, recently used, or saved for checkout)
  List<DiscountRef> get discountRefs =>
...
abstract class $UserProfileCopyWith<$Res> {
  ...
  $Res call({
    ...
    List<FavoriteRef> favoriteRefs,
    List<DiscountRef> discountRefs,
...
class _$UserProfileCopyWithImpl<$Res, $Val extends UserProfile>
  ...
  $Res call({
    ...
    Object? favoriteRefs = null,
    Object? discountRefs = null,
      ...
      _value.copyWith(
            ...
            orderRefs: null == orderRefs
                ...
                : orderRefs // ignore: cast_nullable_to_non_nullable
                      as List<OrderRef>,
            favoriteRefs: null == favoriteRefs
                ? _value.favoriteRefs
                : favoriteRefs // ignore: cast_nullable_to_non_nullable
                      as List<FavoriteRef>,
            discountRefs: null == discountRefs
                ? _value.discountRefs
                : discountRefs // ignore: cast_nullable_to_non_nullable
                      as List<DiscountRef>,
      ...
      _$UserProfileImpl(
        ...
        orderRefs: null == orderRefs
            ...
            : orderRefs // ignore: cast_nullable_to_non_nullable
                  as List<OrderRef>,
        favoriteRefs: null == favoriteRefs
            ? _value._favoriteRefs
            : favoriteRefs // ignore: cast_nullable_to_non_nullable
                  as List<FavoriteRef>,
        discountRefs: null == discountRefs
            ? _value._discountRefs
            : discountRefs // ignore: cast_nullable_to_non_nullable
                  as List<DiscountRef>,
        isEmailVerified: null == isEmailVerified
            ? _value.isEmailVerified
...
class _$UserProfileImpl implements _UserProfile {
  const _$UserProfileImpl({
    ...
    final List<FavoriteRef> favoriteRefs = const <FavoriteRef>[],
    final List<DiscountRef> discountRefs = const <DiscountRef>[],
    ...
    final Map<String, dynamic> roleMetadata = const <String, dynamic>{},
       ...
       _favoriteRefs = favoriteRefs,
       _discountRefs = discountRefs,
  ...
  final List<FavoriteRef> _favoriteRefs;
  // NEW: Things the user has favorited
  @override
  @JsonKey()
  List<FavoriteRef> get favoriteRefs {
    if (_favoriteRefs is EqualUnmodifiableListView) return _favoriteRefs;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_favoriteRefs);
  }

  // NEW: Discounts/coupons associated to or last applied by the user
  // (e.g., per-user codes, recently used, or saved for checkout)
  final List<DiscountRef> _discountRefs;
  // NEW: Discounts/coupons associated to or last applied by the user
  // (e.g., per-user codes, recently used, or saved for checkout)
  @override
  @JsonKey()
  List<DiscountRef> get discountRefs {
    if (_discountRefs is EqualUnmodifiableListView) return _discountRefs;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_discountRefs);
  }
  ...
  @override
  String toString() {
    return 'UserProfile(id: $id, firstName: $firstName, lastName: $lastName, email: $email, contactNumber: $contactNumber, avatarUrl: $avatarUrl, addressRefs: $addressRefs, walletRef: $walletRef, reservationRefs: $reservationRefs, paymentMethodRefs: $paymentMethodRefs, orderRefs: $orderRefs, favoriteRefs: $favoriteRefs, discountRefs: $discountRefs, isEmailVerified: $isEmailVerified, isPhoneVerified: $isPhoneVerified, createdAt: $createdAt, updatedAt: $updatedAt, roleMetadata: $roleMetadata)';
  }
  ...
  int get hashCode => Object.hash(
    ...
    const DeepCollectionEquality().hash(_favoriteRefs),
    const DeepCollectionEquality().hash(_discountRefs),
    isEmailVerified,
    isPhoneVerified,
    createdAt,
    updatedAt,
...
abstract class _UserProfile implements UserProfile {
  const factory _UserProfile({
    ...
    final List<FavoriteRef> favoriteRefs,
    final List<DiscountRef> discountRefs,
    final bool isEmailVerified,
    final bool isPhoneVerified,
    final DateTime? createdAt,
    final DateTime? updatedAt,
  ...
  List<ReservationRef> get reservationRefs;
  @override
  List<PaymentMethodRef> get paymentMethodRefs; // NEW: Orders the user has placed (lightweight snapshots)
  @override
  List<OrderRef> get orderRefs; // NEW: Things the user has favorited
  @override
  List<FavoriteRef> get favoriteRefs; // NEW: Discounts/coupons associated to or last applied by the user
  // (e.g., per-user codes, recently used, or saved for checkout)
  @override
  List<DiscountRef> get discountRefs; // Verification flags
  @override
